...
### Synthetic data
Following a similar scheme in \cite{wang2016graphical}, we simulated an image signal propagation dataset with varying
...
calculating signal propagation \cite{wang2019accurate}, extracting depth information \cite{ishikawa1998occlusions}, and signature identification \cite{okawa2019template}.
